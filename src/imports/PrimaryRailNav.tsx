import svgPaths from "./svg-y1gexucine";
import { imgHome } from "./svg-s034i";
...
export default function PrimaryRailNav() {
  return (
    <div className="bg-[#e5e9f0] content-stretch flex flex-col items-start relative size-full" data-name="Primary Rail Nav">
      <Frame />
      <MainNav />
    </div>
  );
